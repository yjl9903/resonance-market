...
<template>
  <div class="main pb-12">
    <div class="mb-4">
      <span href="#" class="block mt-1 text-lg leading-tight font-medium text-base-800">跑商路线规划</span>
      <div class="mt-2 text-slate-500">
        <p class="mb-2">亲爱的列车长们: </p>
        <p class="ml-2">这是阿妮塔科技为您整理的两地运输路线收益排行。</p>
        <p class="ml-2">我们建议选择城市售价靠前的商品（一般为城市特产品）作为主攻对象，每次使用5本以内的进货采购书将货物尽可能填满车厢，这样可以在单程收益和进货采购数使用量之间维持平衡。</p>
        <p class="ml-2">希望这份排行能为您的运输之路提供参考。</p>
        <p class="ml-2">祝旅途顺利,财源滚滚!</p>
